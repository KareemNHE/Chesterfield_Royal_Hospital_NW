...
<head>
    ...
    <style>
        ...
        .back-button:hover, .login_step_submit:hover {
        ...
        <main class="main" id="content">
            <div class="col-lg-6 col-md-12 col-sm-12 mb-5 no-gutters login-form">
                ...
                <form method="post" action="process_staff_login.php" class="loginform username login_step">
                    ...
                    <input type="hidden" name="authentication_flow[id]" value="AFL0000011DEFBC1" /><input type="hidden" name="authentication_flow[start_process]" value="1" />
                    <div class="row">
                        <div class="col-12">
